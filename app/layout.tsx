...
export const metadata: Metadata = {
  ...
  description: 'Marsof Technology, empresa española de software con sede en Cartaya (Huelva). Desarrolla Saldea, IA que automatiza el cobro de facturas para autónomos y pymes. 1 mes gratis.',
  keywords: [
    'Marsof',
    'Marsof Technology',
    'Marsof Saldea',
...
const schemaOrganizacion = {
  ...
  description: 'Marsof Technology es una empresa española de software con sede en Cartaya (Huelva). Desarrolla Saldea, una IA que automatiza el cobro de facturas impagadas para autónomos y pymes.',
