...
export const metadata: Metadata = {
  ...
  description: 'Saldea es la herramienta española de cobros automáticos con IA, desarrollada en Cartaya (Huelva). Para autónomos y gestorías de Huelva, Cádiz, Sevilla y Andalucía.',
  ...
  keywords: [
    ...
    'Marsof Huelva',
    'Saldea Huelva',
    'cobros morosos Cartaya',
  ],
  openGraph: {
    title: 'Saldea en Huelva: software local de cobros con IA',
    description: 'Desarrollado en Cartaya, para toda Andalucía.',
    type: 'website',
    locale: 'es_ES',
  },
}
      ...
      <div className="min-h-screen bg-zinc-950 text-zinc-100">
        ...
        <section className="max-w-4xl mx-auto px-6 pt-16 pb-12">
          <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/20 text-sky-300 px-3 py-1.5 rounded-full text-xs font-medium mb-6">
            <span>📍 Hecho en Cartaya, Huelva</span>
          </div>
          ...
          <p className="text-zinc-400 text-lg leading-relaxed mb-8">
            <strong>Marsof Technology</strong> es una empresa onubense fundada en Cartaya en 2026. Desarrollamos <strong>Saldea</strong>, una IA que automatiza el cobro de facturas para autónomos, gestorías y pymes de Huelva, Sevilla, Cádiz y todo el país.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-12">
            <div className="bg-zinc-900/40 border border-white/10 rounded-xl p-5">
              ...
              <p className="text-zinc-400 text-sm">Empresa local de Cartaya. Conocemos cómo se hace negocio en la provincia.</p>
            </div>
            <div className="bg-zinc-900/40 border border-white/10 rounded-xl p-5">
          ...
          <ul className="space-y-2 text-zinc-300 mb-8">
            ...
            <li>📊 <strong>Gestorías y asesorías</strong> de Huelva capital, Cartaya, Ayamonte, Lepe, Almonte</li>
          ...
          <div className="bg-zinc-900/40 border border-white/10 rounded-2xl p-6 mb-8">
            <p className="text-zinc-300 leading-relaxed mb-3">
              <strong>Marsof</strong> fue fundada por <strong>Carlos Gálvez Carrillo</strong>, vecino de Cartaya con experiencia en el sector financiero y asesoría a cooperativas locales.
            </p>
            <p className="text-zinc-300 leading-relaxed mb-3">
              Sede: <strong>Cartaya, Huelva (21450)</strong>
            </p>
