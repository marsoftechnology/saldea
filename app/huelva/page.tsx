...
export const metadata: Metadata = {
  ...
  description: 'Saldea es la herramienta española de cobros automáticos con IA, desarrollada en Huelva. Para autónomos y gestorías de Huelva, Cádiz, Sevilla y Andalucía.',
  alternates: { canonical: 'https://www.marsof.es/huelva' },
  keywords: [
    ...
    'Marsof Huelva',
    'Saldea Huelva',
    'cobros morosos Huelva',
  ],
  openGraph: {
    title: 'Saldea en Huelva: software local de cobros con IA',
    description: 'Desarrollado en Huelva, para toda Andalucía.',
    type: 'website',
    locale: 'es_ES',
  },
}
...
const schemaLocal = {
  ...
  image: 'https://www.marsof.es/og-image.png',
  url: 'https://marsof.es',
...
<Link href="/registro" className="bg-sky-500 text-zinc-900 text-sm font-medium px-4 py-2 rounded-lg hover:bg-sky-400 transition-colors">30 días gratis</Link>
        ...
        <section className="max-w-4xl mx-auto px-6 pt-16 pb-12">
          <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/20 text-sky-300 px-3 py-1.5 rounded-full text-xs font-medium mb-6">
            <span>?? Hecho en Huelva, Andalucía</span>
          </div>
          ...
          <p className="text-zinc-400 text-lg leading-relaxed mb-8">
            <strong>Marsof Technology</strong> es una empresa onubense fundada en Huelva en 2026. Desarrollamos <strong>Saldea</strong>, una IA que automatiza el cobro de facturas para autónomos, gestorías y pymes de Huelva, Sevilla, Cádiz y todo el país.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-12">
            <div className="bg-zinc-900/40 border border-white/10 rounded-xl p-5">
              ...
              <p className="text-zinc-400 text-sm">Empresa local de Huelva. Conocemos cómo se hace negocio en la provincia.</p>
            </div>
            <div className="bg-zinc-900/40 border border-white/10 rounded-xl p-5">
              <p className="text-3xl mb-2">????</p>
          ...
          <ul className="space-y-2 text-zinc-300 mb-8">
            ...
            <li>?? <strong>Gestorías y asesorías</strong> de Huelva capital, Ayamonte, Lepe, Almonte</li>
          ...
          <div className="bg-zinc-900/40 border border-white/10 rounded-2xl p-6 mb-8">
            <p className="text-zinc-300 leading-relaxed mb-3">
              <strong>Marsof</strong> fue fundada por <strong>Carlos Gálvez Carrillo</strong>, onubense con experiencia en el sector financiero y asesoría a cooperativas locales.
            </p>
            <p className="text-zinc-300 leading-relaxed mb-3">
              Sede: <strong>Huelva (España)</strong>
            </p>
            <p className="text-zinc-300 leading-relaxed">
              Contacto: <a href="mailto:carlosgc@marsof.es" className="text-sky-400 hover:underline">carlosgc@marsof.es</a>
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-sky-500/15 to-transparent border border-sky-500/30 rounded-2xl p-8 text-center">
            ...
            <p className="text-zinc-400 mb-6">Prueba Saldea 30 días gratis. Si te encaja, pagas. Si no, cancelas. Cero permanencia.</p>
