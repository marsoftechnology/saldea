...
- Transferencia a IBAN [tu IBAN]`}
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Link de pago Stripe automático. Recordatorios si no se paga. Y persigue el resto del pago al entregar. <strong>1 mes gratis.</strong></p>
