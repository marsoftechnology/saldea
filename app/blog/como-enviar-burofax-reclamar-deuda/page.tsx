...
[Tu nombre]`}
          ...
          <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
            ...
            <p className="text-zinc-300 mb-5">Muchos clientes pagan en cuanto reciben un recordatorio firme automático. Saldea manda emails escalados con IA. Si tras 30 días no paga, ya tienes pruebas listas para el burofax. <strong>15 días gratis.</strong></p>
