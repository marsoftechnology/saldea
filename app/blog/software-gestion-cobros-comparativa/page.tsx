    ...
    <article className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-zinc-300 leading-relaxed mb-4"><strong>Precio:</strong> 49€/mes (49€) o 499€/año. 1 mes gratis sin tarjeta.</p>
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">1 mes gratis sin tarjeta hasta el día 31. Cancela en 1 clic. Sin permanencia.</p>
