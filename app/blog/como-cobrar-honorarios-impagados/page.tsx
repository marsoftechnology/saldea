...
const articleSchema = {"@context": "https://schema.org", "@type": "Article", "headline": "C�mo cobrar honorarios impagados (consultores, abogados, m�dicos)", "description": "Plan espec�fico para cobrar honorarios profesionales. Consultores, abogados, m�dicos, arquitectos. Particularidades legales y trucos.", "author": {"@type": "Organization", "name": "Marsof Technology"}, "publisher": {"@type": "Organization", "name": "Marsof Technology", "logo": {"@type": "ImageObject", "url": "https://www.marsof.es/og-image.png"}}, "datePublished": "2026-05-16", "dateModified": "2026-05-16", "inLanguage": "es-ES", "url": "https://www.marsof.es/blog/como-cobrar-honorarios-impagados"}
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <ul className="space-y-2 text-zinc-300 mb-6">
            <li>?? <strong>Colegios profesionales</strong> ofrecen mediaci�n gratuita o low-cost</li>
            <li>?? <strong>Jura de cuentas (abogados):</strong> procedimiento expr�s para cobrar honorarios judiciales</li>
            <li>?? <strong>Aseguradoras m�dicas:</strong> sus propios protocolos y plazos</li>
          ...
          <h3 className="text-xl font-bold text-zinc-100 mt-6 mb-3">M�dicos privados � Aseguradoras</h3>
          ...
          <ul className="space-y-2 text-zinc-300 mb-6">
            ...
            <li>? Cesi�n de propiedad intelectual SOLO tras pago completo</li>
            <li>? Ley 3/2004 expresa</li>
            <li>? Suspensi�n de servicios por impago a 15 d�as</li>
          </ul>
        </section>
