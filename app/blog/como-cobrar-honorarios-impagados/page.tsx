      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <ul className="space-y-2 text-zinc-300 mb-6">
            ...
            <li>⚖️ <strong>Jura de cuentas (abogados):</strong> procedimiento exprés para cobrar honorarios judiciales</li>
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Persigue tus honorarios automáticamente. Recordatorios escalados según los días de retraso. <strong>15 días gratis.</strong></p>
