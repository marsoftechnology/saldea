...
[Tu nombre]                             [Nombre cliente]`}
        ...
        <aside className="mt-12 bg-sky-500/10 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Importa la factura del proyecto. Si tu cliente no paga en 30 días, Saldea le manda recordatorios con la Ley 3/2004 que tú ya pactaste. <strong>30 días gratis.</strong></p>
