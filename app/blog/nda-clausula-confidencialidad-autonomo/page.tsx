...
El incumplimiento de esta cláusula dará derecho a la parte afectada a reclamar daños y perjuicios, así como la cesación inmediata de la conducta infractora.`}
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Datos cifrados en servidores europeos, sin compartir con terceros, RGPD completo. Si necesitas firmar NDA con nosotros, escríbenos a legal@marsof.es. <strong>1 mes gratis.</strong></p>
