    ...
    <article className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Importa tus certificaciones, configura los plazos legales y deja que la IA persiga el cobro. Cita automáticamente la Ley 9/2017 si es obra pública o Ley 3/2004 si es B2B. <strong>1 mes gratis.</strong></p>
