        ...
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
            ...
            <p className="text-zinc-300 mb-5">
              Saldea ejecuta automáticamente los pasos 1 a 5 con IA: manda recordatorios escalados, detecta respuestas, pausa cuando el cliente paga y te avisa solo si hay algo importante. <strong>1 mes gratis.</strong>
            </p>
            <Link
              href="/registro"
