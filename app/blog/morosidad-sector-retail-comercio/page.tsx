...
const articleSchema = {"@context": "https://schema.org", "@type": "Article", "headline": "Morosidad en retail y comercio 2026: cobrar a tiendas y minoristas", "description": "C�mo cobrar facturas a tiendas, comercios y minoristas. Plazos, estacionalidad y estrategias espec�ficas para proveedores de retail.", "author": {"@type": "Organization", "name": "Marsof Technology"}, "publisher": {"@type": "Organization", "name": "Marsof Technology", "logo": {"@type": "ImageObject", "url": "https://www.marsof.es/og-image.png"}}, "datePublished": "2026-05-16", "dateModified": "2026-05-16", "inLanguage": "es-ES", "url": "https://www.marsof.es/blog/morosidad-sector-retail-comercio"}
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <ul className="space-y-2 text-zinc-300 mb-6">
            ...
            <li>?? No contesta el due�o, solo dependientes</li>
