...
[Tu teléfono]`}
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Estructura ABCD aplicada por la IA. Calcula intereses y los inserta en el email. Tú no escribes nada. <strong>1 mes gratis.</strong></p>
