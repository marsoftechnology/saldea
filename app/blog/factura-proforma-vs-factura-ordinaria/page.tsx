...
Se emitirá factura ordinaria tras la aceptación.`}
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Si el cliente acepta la proforma pero después se retrasa con la factura ordinaria, Saldea persigue el cobro automáticamente. <strong>1 mes gratis.</strong></p>
