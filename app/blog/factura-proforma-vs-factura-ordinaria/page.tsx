...
const articleSchema = {"@context": "https://schema.org", "@type": "Article", "headline": "Factura proforma vs factura ordinaria: diferencias 2026", "description": "Qu� es una factura proforma, cu�ndo usarla, diferencias legales con la factura ordinaria y plantilla gratis. Gu�a clara para aut�nomos y empresas.", "author": {"@type": "Organization", "name": "Marsof Technology"}, "publisher": {"@type": "Organization", "name": "Marsof Technology", "logo": {"@type": "ImageObject", "url": "https://www.marsof.es/og-image.png"}}, "datePublished": "2026-05-16", "dateModified": "2026-05-16", "inLanguage": "es-ES", "url": "https://www.marsof.es/blog/factura-proforma-vs-factura-ordinaria"}
    ...
    <article className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold text-zinc-100 mt-8 mb-4">�Qu� es una factura proforma?</h2>
          ...
          <h2 className="text-2xl font-bold text-zinc-100 mt-8 mb-4">�Cu�ndo conviene usarla?</h2>
          <ul className="space-y-2 text-zinc-300 mb-6">
            <li>? <strong>Para enviar un presupuesto formal</strong> al cliente antes de empezar el trabajo.</li>
            <li>? <strong>Para que el cliente solicite financiaci�n</strong> bancaria o fondos antes del pago.</li>
            <li>? <strong>Para operaciones internacionales</strong>, donde se necesita un documento previo al env�o.</li>
          ...
          <h2 className="text-2xl font-bold text-zinc-100 mt-8 mb-4">�Qu� pasa despu�s de la proforma?</h2>
...
Se emitir� factura ordinaria tras la aceptaci�n.`}
          ...
          <ul className="space-y-2 text-zinc-300 mb-6">
            ...
            <li>? <strong>No emitir la factura ordinaria despu�s</strong>. Si te pagan, tienes 30 d�as.</li>
            <li>? <strong>Numeraci�n correlativa con las ordinarias</strong>. Las proformas llevan numeraci�n separada.</li>
          </ul>
        </section>
