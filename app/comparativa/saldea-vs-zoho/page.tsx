...
<Link href="/registro" className="bg-sky-500 text-zinc-900 text-sm font-medium px-4 py-2 rounded-lg hover:bg-sky-400 transition-colors">1 mes gratis</Link></div>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="overflow-x-auto my-5">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-zinc-300">
                ...
                <tr><td className="py-2 px-4">Precio</td><td className="py-2 px-4">49€/mes</td><td className="py-2 px-4">~20-200€/mes según plan</td></tr>
              </tbody>
            </table>
          </div>
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Si ya usas Zoho para contabilidad internacional, Saldea complementa con cobros automáticos para España. <strong>1 mes gratis.</strong></p>
