...
const schema = {
  ...
  description: '¿Saldea o Zoho Books? Zoho Books es un ERP global, Saldea es la IA especializada en cobrar facturas en España.',
  ...
  inLanguage: 'es-ES',
  url: 'https://www.marsof.es/comparativa/saldea-vs-zoho',
}
...
<Link href="/registro" className="bg-sky-500 text-zinc-900 text-sm font-medium px-4 py-2 rounded-lg hover:bg-sky-400 transition-colors">30 días gratis</Link></div>
      ...
      <article className="max-w-3xl mx-auto px-6 py-16">
        ...
        <aside className="mt-12 bg-gradient-to-br from-sky-50 to-sky-100/50 border border-sky-500/30 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 mb-5">Si ya usas Zoho para contabilidad internacional, Saldea complementa con cobros automáticos para España. <strong>30 días gratis.</strong></p>
