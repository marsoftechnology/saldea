...
export const metadata: Metadata = {
  ...
  description: 'La herramienta que persigue tus facturas impagadas por ti con IA. Pensada para autónomos y freelancers españoles. 1 mes gratis.',
...
<Link href="/registro" className="bg-sky-500 text-zinc-900 text-sm font-medium px-4 py-2 rounded-lg hover:bg-sky-400 transition-colors">1 mes gratis</Link>
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-12 text-center">
        ...
        <p className="text-xs text-zinc-500 mt-4">Sin tarjeta hasta el día 31 · Cancela en 1 clic</p>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="bg-zinc-900/40 border border-sky-500/30 rounded-2xl p-8 text-center">
          ...
          <p className="text-xs text-zinc-500 mt-4">Sin tarjeta · Cancela cuando quieras</p>
        </div>
      </section>
