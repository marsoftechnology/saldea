...
export const metadata: Metadata = {
  ...
  description: 'Software con IA para automatizar el cobro de facturas en Las Palmas y Canarias. Para autónomos, hostelería y servicios. 15 días gratis.',
...
<Link href="/registro" className="bg-sky-500 text-zinc-900 text-sm font-medium px-4 py-2 rounded-lg hover:bg-sky-400 transition-colors">15 días gratis</Link></div>
      ...
      <section className="max-w-4xl mx-auto px-6 pt-16 pb-12">
        ...
        <ul className="space-y-2 text-zinc-300 mb-8">
          <li>🏖️ <strong>Turismo y hostelería</strong> (todo el archipiélago)</li>
