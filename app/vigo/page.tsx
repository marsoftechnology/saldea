...
export const metadata: Metadata = {
  ...
  description: 'Software con IA para automatizar el cobro de facturas. Para empresas de Vigo, A Coruña, Pontevedra y toda Galicia. 30 días gratis.',
  alternates: { canonical: 'https://www.marsof.es/vigo' },
